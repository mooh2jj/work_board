...
<form id="form" name="form" action="/member/joinRegiser.do" onsubmit="return checkForm()">
	<table border="1">
		...
		<tr>
			<th>이메일</th>
			<td><input type="text" id="email" name="email" placeholder="이메일을 입력해주세요." style="width:270px;"></td>
		</tr>
		<tr>
			<th>비밀번호</th>
			<td><input type="password" id="pw" name="pw" placeholder="비밀번호를 입력해주세요." style="width:270px;"></td>
		</tr>
		<tr>
			<th>비밀번호확인</th>
